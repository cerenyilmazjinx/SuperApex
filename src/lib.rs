...
#[derive(Debug)]
pub struct SuperApexProcessor {
    verbose: bool,
    processed_count: usize,
}

impl SuperApexProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting SuperApex processing");
    
    let mut processor = SuperApexProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = SuperApexProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = SuperApexProcessor::new(false);
